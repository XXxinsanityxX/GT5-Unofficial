...
public class GT_CropLoader
    ...
    public void run() {
        ...
        try {
            ...
            new GT_BaseCrop(149, "Trollplant", "unknown", 			null,  6, 5, 1000, 1, 4, 0, 0, 5, 2, 8, new String[]{"Troll", "Bad", "Scrap"}, 											GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Flint, 1L), new ItemStack[]{ItemList.IC2_Plantball.get(1, new Object[0]), ItemList.IC2_Scrap.get(1, new Object[0]), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Plutonium241, 1L)});
