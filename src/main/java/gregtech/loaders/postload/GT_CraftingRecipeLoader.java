...
public class GT_CraftingRecipeLoader implements Runnable {
    ...
    public void run() {
        ...
        GT_ModHandler.addCraftingRecipe(new ItemStack(Blocks.torch, 2), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{"C", "S", 'C', OrePrefixes.gem.get(Materials.Lignite), 'S', OrePrefixes.stick.get(Materials.Wood)});
        ...
        GT_ModHandler.addShapelessCraftingRecipe(GT_ModHandler.getIC2Item("lapotronCrystal", 1L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{ItemList.Lapotron_Crystal.get(1L)});
        GT_ModHandler.addShapelessCraftingRecipe(GT_ModHandler.getIC2Item("energyCrystal", 1L), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{ItemList.Energy_Crystal.get(1L)});
