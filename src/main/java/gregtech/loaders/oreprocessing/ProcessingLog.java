...
public class ProcessingLog implements gregtech.api.interfaces.IOreRecipeRegistrator {
    ...
    public void addPyrolyeOvenRecipes(ItemStack logStack){
        GT_Values.RA.addCokeOvenRecipes(GT_Utility.copyAmount(1L, new Object[]{logStack}), Materials.Charcoal.getGems(1), Materials.Creosote.getFluid(200), 800);
        GT_Values.RA.addCokeOvenRecipes(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sugar, 1L), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Charcoal, 2L), Materials.Water.getFluid(20), 800);
