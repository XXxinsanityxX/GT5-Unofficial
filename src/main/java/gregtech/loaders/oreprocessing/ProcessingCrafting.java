    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
        switch (aOreDictName) {
            ...
            case "craftingLensBlue":
                ...
                GT_Values.RA.addLaserEngraverRecipe(ItemList.Lapotron_Crystal.get(1L), GT_Utility.copyAmount(0L, new Object[]{aStack}), ItemList.Circuit_Parts_Crystal_Chip_Master.get(3), 256, 480,true);
