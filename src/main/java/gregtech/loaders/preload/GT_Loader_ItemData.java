...
public class GT_Loader_ItemData
    ...
    public void run() {
        ...
        GT_OreDictUnificator.addItemData(new ItemStack(Blocks.hardened_clay, 1, 32767), new ItemData(Materials.Brick, 3628800L));
        GT_OreDictUnificator.addItemData(new ItemStack(Blocks.stained_hardened_clay, 1, 32767), new ItemData(Materials.Brick, 3628800L));
