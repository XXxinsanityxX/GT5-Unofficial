...
public class GT_GUIContainer_CokeOven extends GT_GUIContainerMetaTile_Machine {
    ...
    public GT_GUIContainer_CokeOven(InventoryPlayer aInventoryPlayer, IGregTechTileEntity aTileEntity, String aName, String aTextureFile, String aNEI) {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        if (mContainer != null) {
            ...
            if ((int)tScale > 0 && (int)tScale < 100)
                fontRendererObj.drawString(GT_Utility.formatNumbers((int)tScale) + "/100%", 55, 40, 16448255);
            else fontRendererObj.drawString("", 65, 50, 16448255);
        }
    }
