...
public class GT_MetaTileEntity_Boiler_Semifluids
        extends GT_MetaTileEntity_Boiler {
    public GT_MetaTileEntity_Boiler_Semifluids(int aID, String aName, String aNameRegional) {
        super(aID, aName, aNameRegional, new String[]{
                "A Boiler running off Creosote Oil",
                "Produces 600L of Steam per second",
                "Causes 20 Pollution per second"});
    }

    public GT_MetaTileEntity_Boiler_Semifluids(String aName, int aTier, String aDescription, ITexture[][][] aTextures) {
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new GT_MetaTileEntity_Boiler_Semifluids(this.mName, this.mTier, this.mDescriptionArray, this.mTextures);
    }
    ...
    public final int fill(FluidStack aFluid, boolean doFill) {
        if ((GT_ModHandler.isCreosote(aFluid)) && (this.mProcessingEnergy < 50)) {
