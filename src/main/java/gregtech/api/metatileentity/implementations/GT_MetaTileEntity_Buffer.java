...
public abstract class GT_MetaTileEntity_Buffer extends GT_MetaTileEntity_TieredMachineBlock {
    ...
    public ITexture[][][] getTextureSet(ITexture[] aTextures) {
        ...
        for (int i = 0; i < rTextures[0].length; i++) {
            rTextures[OUTPUT_INDEX][i] = new ITexture[]{new GT_RenderedTexture(Textures.BlockIcons.CASING_MACHINE), tOut};
            rTextures[ARROW_RIGHT_INDEX][i] = new ITexture[]{new GT_RenderedTexture(Textures.BlockIcons.CASING_MACHINE), tRight, tIcon};
            rTextures[ARROW_DOWN_INDEX][i] = new ITexture[]{new GT_RenderedTexture(Textures.BlockIcons.CASING_MACHINE), tDown, tIcon};
            rTextures[ARROW_LEFT_INDEX][i] = new ITexture[]{new GT_RenderedTexture(Textures.BlockIcons.CASING_MACHINE), tLeft, tIcon};
            rTextures[ARROW_UP_INDEX][i] = new ITexture[]{new GT_RenderedTexture(Textures.BlockIcons.CASING_MACHINE), tUp, tIcon};
            rTextures[FRONT_INDEX][i] = new ITexture[]{new GT_RenderedTexture(Textures.BlockIcons.CASING_MACHINE), tIcon};
        }
        return rTextures;
    }
